...
void Cvijet::draw()
{
	sf::RectangleShape stemaxis(sf::Vector2f(10.f, 150.f));
	...
	leaf.setPoint(1, sf::Vector2f(250.f, 300.f));
	leaf.setPoint(2, sf::Vector2f(200.f, 325.f));
	leaf.setPoint(3, sf::Vector2f(200.f, 300.f));
