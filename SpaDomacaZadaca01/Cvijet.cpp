...
std::vector<sf::CircleShape> Cvijet::get_latice() const
{
	return latice;
}
...
void Cvijet::set_stabljuka(const sf::RectangleShape stabljika)
{
...
void Cvijet::set_latica(const sf::CircleShape latica, const int i)
{
	this->latice.at(i) = latica;
}

bool Cvijet::get_ran() const
{
	return ran;
}

void Cvijet::set_ran(const bool ran)
{
	this->ran = ran;
}
